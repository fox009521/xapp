...
namespace HealthCloud.DBDAL
{
	...
	public partial class SENDINFO
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(HealthCloud.DBModel.SENDINFO model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into NT_SENDINFO(");
			strSql.Append("F_GID,F_SEND_CONTENT,F_SEND_USER,F_SEND_TIME,F_SEND_TYPE,F_INDATE,F_REDATE,F_STATUS)");
			...
			parameters[1].Value = model.F_SEND_CONTENT;
			parameters[2].Value = model.F_SEND_USER;
			parameters[3].Value = model.F_SEND_TIME;
			parameters[4].Value = model.F_SEND_TYPE;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(HealthCloud.DBModel.SENDINFO model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update NT_SENDINFO set ");
		...
		public bool Delete(int F_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from NT_SENDINFO ");
			strSql.Append(" where F_ID=@F_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@F_ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public HealthCloud.DBModel.SENDINFO GetModel(int F_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 F_ID,F_GID,F_SEND_CONTENT,F_SEND_USER,F_SEND_TIME,F_SEND_TYPE,F_INDATE,F_REDATE,F_STATUS from NT_SENDINFO ");
			strSql.Append(" where F_ID=@F_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@F_ID", SqlDbType.Int,4)
			};
			...
			HealthCloud.DBModel.SENDINFO model=new HealthCloud.DBModel.SENDINFO();
		...
		/// 得到一个对象实体
		/// </summary>
		public HealthCloud.DBModel.SENDINFO DataRowToModel(DataRow row)
		{
			HealthCloud.DBModel.SENDINFO model=new HealthCloud.DBModel.SENDINFO();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select F_ID,F_GID,F_SEND_CONTENT,F_SEND_USER,F_SEND_TIME,F_SEND_TYPE,F_INDATE,F_REDATE,F_STATUS ");
			strSql.Append(" FROM NT_SENDINFO ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" F_ID,F_GID,F_SEND_CONTENT,F_SEND_USER,F_SEND_TIME,F_SEND_TYPE,F_INDATE,F_REDATE,F_STATUS ");
			strSql.Append(" FROM NT_SENDINFO ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM NT_SENDINFO ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from NT_SENDINFO T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "NT_SENDINFO";
