...
namespace HealthCloud.DBDAL
{
	...
	/// 数据访问类:V_NT_EXAMIN
	/// </summary>
	public partial class V_NT_EXAMIN
	{
		public V_NT_EXAMIN()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public long Add(HealthCloud.DBModel.V_NT_EXAMIN model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into V_NT_EXAMIN(");
			strSql.Append("F_GID,F_PTNO,F_DEVICE_NO,F_DEVICE_TIME,F_USERNUM,F_RFID,F_SBP,F_DBP,F_HR,F_BODY_TEMP,F_GLUCOSE,F_WEIGHT,F_CHOL,F_UA,F_ROOM_TEMP,F_INDATE,F_REDATE,F_STATUS,F_ERROR,F_MEMO,F_BAK1,F_BAK2,F_BAK3,F_BAK4,F_XUEYA)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@F_USERNUM", SqlDbType.Char,10),
			...
			parameters[24].Value = model.F_XUEYA;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(HealthCloud.DBModel.V_NT_EXAMIN model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update V_NT_EXAMIN set ");
		...
		public bool Delete(long F_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from V_NT_EXAMIN ");
			strSql.Append(" where F_ID=@F_ID");
			SqlParameter[] parameters = {
		...
		/// 得到一个对象实体
		/// </summary>
		public HealthCloud.DBModel.V_NT_EXAMIN GetModel(long F_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 F_ID,F_GID,F_PTNO,F_DEVICE_NO,F_DEVICE_TIME,F_USERNUM,F_RFID,F_SBP,F_DBP,F_HR,F_BODY_TEMP,F_GLUCOSE,F_WEIGHT,F_CHOL,F_UA,F_ROOM_TEMP,F_INDATE,F_REDATE,F_STATUS,F_ERROR,F_MEMO,F_BAK1,F_BAK2,F_BAK3,F_BAK4,F_XUEYA from V_NT_EXAMIN ");
			strSql.Append(" where F_ID=@F_ID");
			SqlParameter[] parameters = {
					new SqlParameter("@F_ID", SqlDbType.BigInt)
			};
			...
			HealthCloud.DBModel.V_NT_EXAMIN model=new HealthCloud.DBModel.V_NT_EXAMIN();
		...
		/// 得到一个对象实体
		/// </summary>
		public HealthCloud.DBModel.V_NT_EXAMIN DataRowToModel(DataRow row)
		{
			HealthCloud.DBModel.V_NT_EXAMIN model=new HealthCloud.DBModel.V_NT_EXAMIN();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select F_ID,F_GID,F_PTNO,F_DEVICE_NO,F_DEVICE_TIME,F_USERNUM,F_RFID,F_SBP,F_DBP,F_HR,F_BODY_TEMP,F_GLUCOSE,F_WEIGHT,F_CHOL,F_UA,F_ROOM_TEMP,F_INDATE,F_REDATE,F_STATUS,F_ERROR,F_MEMO,F_BAK1,F_BAK2,F_BAK3,F_BAK4,F_XUEYA ");
			strSql.Append(" FROM V_NT_EXAMIN ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" F_ID,F_GID,F_PTNO,F_DEVICE_NO,F_DEVICE_TIME,F_USERNUM,F_RFID,F_SBP,F_DBP,F_HR,F_BODY_TEMP,F_GLUCOSE,F_WEIGHT,F_CHOL,F_UA,F_ROOM_TEMP,F_INDATE,F_REDATE,F_STATUS,F_ERROR,F_MEMO,F_BAK1,F_BAK2,F_BAK3,F_BAK4,F_XUEYA ");
			strSql.Append(" FROM V_NT_EXAMIN ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM V_NT_EXAMIN ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from V_NT_EXAMIN T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "V_NT_EXAMIN";
