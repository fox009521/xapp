...
namespace HealthCloud.DBDAL
{
	...
	/// 数据访问类:Manage_Log
	/// </summary>
	public partial class Manage_Log
	{
		public Manage_Log()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int Add(HealthCloud.DBModel.Manage_Log model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Manage_Log(");
			strSql.Append("f_gid,F_USERID,F_USERNAME,F_TOKEN,F_VER_OS,F_VER_SOFT,F_IP,F_HARDINFO,F_OPERTIME,F_OPERCONTENT)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(HealthCloud.DBModel.Manage_Log model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Manage_Log set ");
		...
		public bool Delete(int f_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Manage_Log ");
			strSql.Append(" where f_id=@f_id");
			SqlParameter[] parameters = {
					new SqlParameter("@f_id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public HealthCloud.DBModel.Manage_Log GetModel(int f_id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 f_id,f_gid,F_USERID,F_USERNAME,F_TOKEN,F_VER_OS,F_VER_SOFT,F_IP,F_HARDINFO,F_OPERTIME,F_OPERCONTENT from Manage_Log ");
			strSql.Append(" where f_id=@f_id");
			SqlParameter[] parameters = {
					new SqlParameter("@f_id", SqlDbType.Int,4)
			};
			...
			HealthCloud.DBModel.Manage_Log model=new HealthCloud.DBModel.Manage_Log();
		...
		/// 得到一个对象实体
		/// </summary>
		public HealthCloud.DBModel.Manage_Log DataRowToModel(DataRow row)
		{
			HealthCloud.DBModel.Manage_Log model=new HealthCloud.DBModel.Manage_Log();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select f_id,f_gid,F_USERID,F_USERNAME,F_TOKEN,F_VER_OS,F_VER_SOFT,F_IP,F_HARDINFO,F_OPERTIME,F_OPERCONTENT ");
			strSql.Append(" FROM Manage_Log ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" f_id,f_gid,F_USERID,F_USERNAME,F_TOKEN,F_VER_OS,F_VER_SOFT,F_IP,F_HARDINFO,F_OPERTIME,F_OPERCONTENT ");
			strSql.Append(" FROM Manage_Log ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM Manage_Log ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Manage_Log T ");
